  ...
  render() {
    return (
      <div>
        ...
        >
          <path
            d="M480,85.333c-17.646,0-32,14.354-32,32V256h-74.667c-17.646,0-32,14.354-32,32s14.354,32,32,32h53.333v85.333h-32
        ...
        c0-5.896-4.771-10.667-10.667-10.667h-32V320h32c17.646,0,32-14.354,32-32V117.333C512,99.688,497.646,85.333,480,85.333z"
          />
          <path
            d="M138.667,256H64V117.333c0-17.646-14.354-32-32-32s-32,14.354-32,32V288c0,17.646,14.354,32,32,32h32v85.333H32
        ...
        c0-5.896-4.771-10.667-10.667-10.667h-32V320h53.333c17.646,0,32-14.354,32-32S156.313,256,138.667,256z"
          />
          <path
            d="M284.99,243.75c9.333,5.74,19.917,12.25,40.281,12.25c20.365,0,30.948-6.51,40.281-12.25
...
Table.defaultProps = {
  ...
  width: "70px",
  fill: "green",
  pathid_temp_side: "temp-side",
  fill_temp_side: "",
  pathid_temp_in: "temp-in",
  fill_temp_in: "",
  pathid_temp_out: "temp-out",
  fill_temp_out: "",
  animate_state: "Null"
};
